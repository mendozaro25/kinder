    ...
    */
    ...
    protected function init()
    {
        if ($this->CI->session->has_userdata("userID") && $this->CI->session->loginStatus) {
			...
			$this->fullName = $this->CI->session->fullName;
			$this->photo = $this->CI->session->photo;
        }
    ...
    {
        $this->error["failed"] = "Usuario y/o contraseña incorrecto.";
    ...
    {
        $this->CI->session->unset_userdata(array("userID", "username", "fullName", "loginStatus"));

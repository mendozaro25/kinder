    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url() ?>menus/menu"><?= $uri["title"] ?></a></li>
            </ol>
        </div>
                    ...
                    <div class="">
                        <table id="table1" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th width="50px">pariente</th>
                                <th width="50px">controlador</th>
                                <th width="50px">método (func.)</th>
                                <th width="50px">icono</th>

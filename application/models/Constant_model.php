...
class Constant_model extends CI_Model
{
    ...
    // Query Data from Table by One Columns;
    public function getSingleOneColumn($table, $col1_name, $col1_value)
    {
        $this->db->where("$col1_name", $col1_value);
    ...
    public function getSingleTwoColumn($table, $col1_name, $col1_value, $col2_name, $col2_value)
    {
        $this->db->where("$col1_name", $col1_value);
    ...
    // Update Data to Any Table;
    public function updateDataJornada($table, $data, $id)
    {
